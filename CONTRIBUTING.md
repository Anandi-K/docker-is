...
Unlike most projects, development for this repository is carried out on the `6.0.x` branch. This is because the `master` branch contains the latest stable release of the project.
